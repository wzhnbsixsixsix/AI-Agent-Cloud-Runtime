...
export interface CreateAgentInput { name: string; role: string; systemPrompt: string; model?: 'glm-4.7-flash' | 'Qwen/Qwen3.6-27B'; image?: string; cpuQuotaUs?: number; memoryMb?: number; pidsLimit?: number; tools?: string[]; workspacePolicy?: 'retain' | 'delete' }
